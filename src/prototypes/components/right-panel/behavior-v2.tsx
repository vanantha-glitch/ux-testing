...
export default function RightPanelBehaviorV2() {
                        ...
                        >
                          ...
                          {supportEnabled && (
                            <>
                              ...
                              <div className="space-y-1">
                                ...
                                >
                                  <div className="flex items-center gap-2 px-2 py-2 rounded transition-colors">
                                    <RadioGroupItem value="1" id="extruder-1-behavior-v2" />
                                    <Label htmlFor="extruder-1-behavior-v2" className="text-xs text-[#282828] cursor-pointer">
                                      Extruder 1
                                    </Label>
                                  </div>
                                  <div className="flex items-center gap-2 px-2 py-2 rounded transition-colors">
                                    <RadioGroupItem value="2" id="extruder-2-behavior-v2" />
                                    <Label htmlFor="extruder-2-behavior-v2" className="text-xs text-[#282828] cursor-pointer">
                                      Extruder 2
                                    </Label>
                                  </div>
                                </RadioGroup>
                              ...
                              <div className="flex flex-col gap-2">
                                <Label id="support-type-label-behavior-v2" htmlFor="support-type-select-behavior-v2" className="text-xs font-normal text-[#282828]">Type</Label>
                                <Select defaultValue="option">
                                  <SelectTrigger id="support-type-select-behavior-v2" className="h-8 text-xs border-[#EAEAEA]" aria-labelledby="support-type-label-behavior-v2">
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                              ...
                              {/* Placement Dropdown */}
                              <div className="flex flex-col gap-2">
                                <Label id="support-placement-label-behavior-v2" htmlFor="support-placement-select-behavior-v2" className="text-xs font-normal text-[#282828]">Placement</Label>
                                <Select defaultValue="option">
                                  <SelectTrigger id="support-placement-select-behavior-v2" className="h-8 text-xs border-[#EAEAEA]" aria-labelledby="support-placement-label-behavior-v2">
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                                    <SelectItem value="option">Option</SelectItem>
                          ...
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              ...
                              <Label id="resolution-label-behavior-v2" htmlFor="resolution-select-behavior-v2" className="text-xs font-normal text-[#282828]">Resolution</Label>
                            </div>
                            <Select value={resolutionValue} onValueChange={setResolutionValue}>
                              <SelectTrigger id="resolution-select-behavior-v2" className="h-8 text-xs border-[#EAEAEA]" aria-labelledby="resolution-label-behavior-v2">
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                                <SelectItem value="option">Option</SelectItem>
                          ...
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              ...
                              <Label id="infill-pattern-label-behavior-v2" htmlFor="infill-pattern-select-behavior-v2" className="text-xs font-normal text-[#282828]">Infill Pattern</Label>
                            </div>
                            <Select defaultValue="option">
                              <SelectTrigger id="infill-pattern-select-behavior-v2" className="h-8 text-xs border-[#EAEAEA]" aria-labelledby="infill-pattern-label-behavior-v2">
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                                <SelectItem value="option">Option</SelectItem>
                          ...
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              ...
                              <Label id="adhesion-label-behavior-v2" htmlFor="adhesion-select-behavior-v2" className="text-xs font-normal text-[#282828]">Adhesion</Label>
                            </div>
                            <Select value={adhesionValue} onValueChange={setAdhesionValue}>
                              <SelectTrigger id="adhesion-select-behavior-v2" className="h-8 text-xs border-[#EAEAEA]" aria-labelledby="adhesion-label-behavior-v2">
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
